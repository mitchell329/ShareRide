        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case  R.id.registerPageButton:
                    RegistrationFragment registrationFragment = RegistrationFragment.newInstance("register", "register");
                    fragmentTransaction.replace(R.id.frameContainer, registrationFragment);
